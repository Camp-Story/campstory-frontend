export default function CampingDetail() {
    ...
    return (
        <>
            <section>
                <div className="text-[26px] font-bold mb-5">인근 명소</div>
                <div className="flex flex-wrap justify-between">
                    <div>
                        <img src="/public/images/camping/camping-popular-dummy1.png" alt="인근 명소 이미지" className="w-[228px] h-[228px] rounded-xl mb-[10px]"/>
                        <div className="flex justify-between items-center">
                            <div>
                                <div className="text-[13px] font-bold text-gray-scale-300 mb-[7px]">카테고리</div>
                                <div className="text-[15px]">주변 맛집 이름</div>
                            </div>
                            <svg
                                width="30"
                                height="30"
