...
export default function ProductCard({ src, brand, productName, discount, price }: ShoppingProps) {
  return (
    <div className="flex flex-col gap-3">
      <div className="w-[240px] h-[240px] overflow-hidden">
        <img src={src} alt="productImage" className="w-[100%] h-[100%] object-cover rounded" />
      </div>
      <div className="flex justify-between items-center">
        <div>
          <div className="text-body2 text-gray-scale-400">{brand}</div>
