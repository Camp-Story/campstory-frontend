      ...
      <div className="flex-1 flex flex-col gap-8">
            ...
            <div className="flex justify-end gap-2">
              ...
              >
                ...
                <path
                  ...
                  stroke-linejoin="round"
                />
                <path d="M28.1452 18.7708L20.8535 22.9374" stroke="#B4B4B4" stroke-width="2" />
                <path d="M20.8535 26.0625L28.1452 30.2292" stroke="#B4B4B4" stroke-width="2" />
              </svg>
              <svg
                width="40"
                height="40"
        ...
        <div>
          ...
          <p className="text-body1 text-gray-scale-400">
            2025년 을사년이 행복한 한해가 되기를 염원하며 감악산 일원에서 해맞이 행사를 진행한다.
            새해 첫날 해오름의 벅찬 감동의 순간을 가족, 이웃과 함께 맞이하고 힘차게 솟아 오르는 밝은
            희망을 가슴에 안고 새해 소망을 기원한다. 풍물패 공연, 소원 박 터뜨리기, 새해소망 소원
            적기, 떡국 시식 등 다양한 부대행사가 준비되어있다.
          </p>
        </div>
      </div>
